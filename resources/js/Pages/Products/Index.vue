...
<template>
    <AppLayout>
        ...
        <div class="flex flex-col gap-6 md:flex-row md:items-center md:justify-between mb-8">
            <div>
                <p class="text-[10px] font-semibold uppercase tracking-[0.3em] text-[#023e8a]/60">Stock management</p>
        ...
        <div class="mb-6 flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            ...
            <div class="flex items-center gap-2 px-4 py-2 bg-slate-50 rounded-lg border border-slate-100">
                ...
                <span class="text-sm font-bold text-[#023e8a]">{{ filteredProducts.length }}</span>
            </div>
        </div>
                ...
                <table class="w-full text-left border-collapse">
                    <thead>
                        <tr class="bg-slate-100/30">
                            ...
                            <th @click="toggleSort('sku')" class="group cursor-pointer px-8 py-5 text-[10px] font-semibold uppercase tracking-widest text-slate-400 select-none hover:text-[#023e8a] transition-colors">
                                <div class="flex items-center gap-2">
                                    SKU Code
                            ...
                            <th @click="toggleSort('price')" class="group cursor-pointer px-8 py-5 text-[10px] font-semibold uppercase tracking-widest text-slate-400 select-none hover:text-[#023e8a] transition-colors">
                                <div class="flex items-center gap-2">
                                    Unit Price
                        ...
                        >
                            <td class="px-8 py-6">
                                <div class="flex items-center gap-4">
                                    ...
                                    <span class="font-semibold text-slate-900 group-hover:text-[#023e8a] transition-colors">{{ product.name }}</span>
                                </div>
                            </td>
                            <td class="px-8 py-6">
                ...
                <div class="pointer-events-auto w-full max-w-2xl rounded-[2rem] bg-white p-10 shadow-2xl relative border border-slate-100 flex flex-col gap-8">
                    ...
                    >
                        <div class="col-span-2">
                            ...
                            <input v-model="form.name" required class="w-full rounded-xl border-none bg-slate-50 px-6 py-4 text-sm font-semibold text-slate-900 ring-1 ring-slate-200 focus:ring-2 focus:ring-[#023e8a] transition-all outline-none" placeholder="e.g. Premium Consultation" />
                        </div>
                        <div>
                            <label class="block text-[10px] font-semibold uppercase tracking-widest text-slate-400 mb-2 px-1">SKU Identification</label>
                            <input v-model="form.sku" required class="w-full rounded-xl border-none bg-slate-50 px-6 py-4 text-sm font-semibold text-slate-900 ring-1 ring-slate-100 focus:ring-2 focus:ring-[#023e8a] transition-all outline-none" placeholder="SKU-001" />
                        </div>
                        <div>
                            <label class="block text-[10px] font-semibold uppercase tracking-widest text-slate-400 mb-2 px-1">Selling Price (USD)</label>
                            <input v-model="form.price" type="number" step="0.01" min="0" required class="w-full rounded-xl border-none bg-slate-50 px-6 py-4 text-sm font-semibold text-slate-900 ring-1 ring-slate-100 focus:ring-2 focus:ring-[#023e8a] transition-all outline-none" placeholder="0.00" />
                        </div>
                        <div class="col-span-2">
                            <label class="block text-[10px] font-semibold uppercase tracking-widest text-slate-400 mb-2 px-1">Detailed Description</label>
                            <textarea v-model="form.description" rows="3" class="w-full rounded-xl border-none bg-slate-50 px-6 py-4 text-sm font-semibold text-slate-900 ring-1 ring-slate-100 focus:ring-2 focus:ring-[#023e8a] transition-all outline-none resize-none" placeholder="Brief details for indexing..."></textarea>
                        </div>
                    ...
                    >
                        <div class="col-span-2">
                            <label class="block text-[10px] font-semibold uppercase tracking-widest text-slate-400 mb-2 px-1">Display Name</label>
                            <input v-model="editForm.name" required class="w-full rounded-xl border-none bg-slate-50 px-6 py-4 text-sm font-semibold text-slate-900 ring-1 ring-slate-200 focus:ring-2 focus:ring-[#023e8a] transition-all outline-none" placeholder="e.g. Premium Consultation" />
                        </div>
                        <div>
                            <label class="block text-[10px] font-semibold uppercase tracking-widest text-slate-400 mb-2 px-1">SKU Identification</label>
                            <input v-model="editForm.sku" required class="w-full rounded-xl border-none bg-slate-50 px-6 py-4 text-sm font-semibold text-slate-900 ring-1 ring-slate-100 focus:ring-2 focus:ring-[#023e8a] transition-all outline-none" placeholder="SKU-001" />
                        </div>
                        <div>
                            <label class="block text-[10px] font-semibold uppercase tracking-widest text-slate-400 mb-2 px-1">Selling Price (USD)</label>
                            <input v-model="editForm.price" type="number" step="0.01" min="0" required class="w-full rounded-xl border-none bg-slate-50 px-6 py-4 text-sm font-semibold text-slate-900 ring-1 ring-slate-100 focus:ring-2 focus:ring-[#023e8a] transition-all outline-none" placeholder="0.00" />
                        </div>
                        <div class="col-span-2">
                            <label class="block text-[10px] font-semibold uppercase tracking-widest text-slate-400 mb-2 px-1">Detailed Description</label>
                            <textarea v-model="editForm.description" rows="3" class="w-full rounded-xl border-none bg-slate-50 px-6 py-4 text-sm font-semibold text-slate-900 ring-1 ring-slate-100 focus:ring-2 focus:ring-[#023e8a] transition-all outline-none resize-none" placeholder="Brief details for indexing..."></textarea>
                        </div>
